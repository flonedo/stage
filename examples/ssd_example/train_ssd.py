...
def parse_args():
    ...
    parser.add_argument('--train-dataset', type=str, default='train_ssd.lst',
                        help='Training dataset.')
    parser.add_argument('--valid-dataset', type=str, default='valid_ssd.lst',
                    help='Validation dataset. Now support voc.')
    parser.add_argument('--synset', type=str, default='synset_short.txt',
