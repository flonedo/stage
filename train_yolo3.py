...
from load_classes import get_dataset_classes
import os
#from gluoncv.data import LstDetection
...
def parse_args():
    ...
    parser.add_argument('--train-dataset', type=str, default='../yolo3_darknet53_custom/train_short.lst',
                        help='Training dataset.')
    parser.add_argument('--valid-dataset', type=str, default='../yolo3_darknet53_custom/valid_short.lst',
                        help='Validation dataset. Now support voc.')
    parser.add_argument('--synset', type=str, default='../yolo3_darknet53_custom/synset_short.txt',
                        help='Class names synset.')
    parser.add_argument('--num-workers', '-j', dest='num_workers', type=int,
                        default=0, help='Number of data workers, you can use larger '
                        'number to accelerate data loading, if you CPU and GPUs are powerful.')
    parser.add_argument('--gpus', type=str, default='',
                        help='Training with GPUs, you can specify 1,3 for example. Defaults to CPU.')
    ...
    parser.add_argument('--export-epoch', type=int, default=1,
                        help='Training epoch in which the network model + params will be exported.')
...
def train(net, train_data, val_data, eval_metric, ctx, args):
    ...
    lr_scheduler = LRScheduler(mode='step',
                               baselr=args.lr,
                               niters=args.num_samples // args.batch_size, # ca 140/8 = 16
                               nepochs=args.epochs,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch == args.export_epoch:
            net.export("network", epoch=args.export_epoch)
